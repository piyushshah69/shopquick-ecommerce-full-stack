...
function AdminSidebar() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <Link to="/admin" className="bg-white flex p-2">
          <img src={logo} className="w-2/3 mix-blend-multiply mx-auto hover:scale-105 transition"/>
        </Link>
      </div>
      ...
      <div className="mt-6">
        <button onClick={handleLogout} className="w-full bg-red-500 hover:bg-red-600 text-white py-2 rounded flex items-center justify-center space-x-2 cursor-pointer">
          <FaSignOutAlt />
          <span>Logout</span>
        </button>
      </div>
